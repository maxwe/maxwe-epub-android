 ...
 * Description: @TODO
 */
public class PageView extends FrameLayout implements View.OnClickListener, View.OnLongClickListener, SelectionIndicator.OnDragSelectionIndicator {
    ...
    public PageView(Context context, String pageName) {
        super(context);
    ...
    public PageView setPageIndex(int pageIndex) {
        this.pageIndex = pageIndex;
        return this;
    }

    public PageView reset() {
        this.startX = 0;
        this.startY = 0;
        this.endX = 0;
        this.endY = 0;
